...
A observação prática ainda é útil: **o mesmo pipeline de evidências SourceShelf produziu respostas substancialmente melhores no macOS 27.** Você pode ver o fluxo de trabalho de pesquisa subjacente em nosso [Exemplo de planejamento de viagem ao Japão](/pt-BR/examples/japan-trip-ai-planner/).
...
Nosso [guia para Open Knowledge Format](/pt-BR/blog/what-is-open-knowledge-format-okf/) explica como o Markdown, metadados, procedência e um índice mantêm esse conhecimento portátil. A [especificação OKF](https://github.com/GoogleCloudPlatform/knowledge-catalog/blob/main/okf/SPEC.md) descreve o próprio formato.
