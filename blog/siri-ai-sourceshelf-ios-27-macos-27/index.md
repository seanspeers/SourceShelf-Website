...
Our [guide to Open Knowledge Format](/blog/what-is-open-knowledge-format-okf/) explains how Markdown, metadata, provenance, and an index keep that knowledge portable. The [OKF specification](https://github.com/GoogleCloudPlatform/knowledge-catalog/blob/main/okf/SPEC.md) describes the format itself.
