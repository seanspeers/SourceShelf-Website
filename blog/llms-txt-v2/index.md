...
The `llms.txt` proposal has reached version 2, updating the emerging convention for helping AI assistants and agents find useful, machine-friendly content on websites. If the format is new to you, start with our [introduction to llms.txt](/blog/what-is-llms-txt/).
